...
from data_pre import data_reader
from utils import Target_Model_pred_fn
from utils import fn_R_given_Selected
from utils import fn_Sample_Generator
from utils import fn_Jacobian_Calculation
...
for dataset in datasets:
    for model in target_models:
        ...
        accuracy = accuracy_score(y_attack, y_attack_pred)
        # Calculate False Alarm Rate
        confusion_matrix = confusion_matrix(y_attack, y_attack_pred)
        ...
        print("False Alarm Rate:", "{:.3f}".format(FAR))